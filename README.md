[![GoDoc](https://godoc.org/github.com/RadicalApp/goquery?status.png)](https://godoc.org/github.com/reachout-chat/axolotl-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/reachout-chat/axolotl-go)](https://goreportcard.com/report/github.com/reachout-chat/axolotl-go)
...
- [API Reference](https://godoc.org/github.com/reachout-chat/axolotl-go)
...
Install the Signal library using the "go get" command:
    ...
    go get github.com/reachout-chat/axolotl-go/...
...
```go
import "github.com/reachout-chat/axolotl-go/serializer"
